...
# 📖 Greeting_App <a name="about-project"></a>

**Greeting_App** is web app that display greetings from rails API with react as the front-end in two apps.
...
```sh
  cd my-folder
  git clone https://github.com/principlebrothers/hello_react.git
```
...
Feel free to check the [issues page](https://github.com/principlebrothers/hello_react/issues/new).
